    ...
    return (
        <div>
            {Array(3).fill(0).map((_, index) => (
                <div key={index} className='card my-8 flex flex-wrap md:flex-nowrap gap-2 p-3 m-3 animate-pulse'>
                        ...
                        <div className='flex flex-wrap md:flex-nowrap justify-between'>
                            ...
                            <div className='flex flex-col mb-4 w-full md:w-1/3'>
                                ...
                                {Array(3).fill(0).map((_, idx) => (
                                    <li key={idx} className='h-4 bg-gray-300 rounded w-full mb-1'></li>
                                ))}
                            </div>
                            <div className='flex flex-col mb-4 w-full md:w-1/3'>
                                <span className='h-4 bg-gray-300 rounded w-1/4 mb-2'></span>
